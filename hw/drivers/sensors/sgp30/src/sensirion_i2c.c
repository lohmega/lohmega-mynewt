...
static uint8_t g_sgp30_i2c_bus = 0;
...
int8_t sensirion_i2c_read(uint8_t address, uint8_t* data, uint16_t count) 
{
    ...
    err = hal_i2c_master_read(g_sgp30_i2c_bus, &op, SENSIRION_RW_TIMEOUT, 1);
...
#pragma GCC diagnostic pop
    ...
    err = hal_i2c_master_write(g_sgp30_i2c_bus, &op, SENSIRION_RW_TIMEOUT, 1);
